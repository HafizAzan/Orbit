...
import { BRAND_COLOR_PRESETS, BRANDING_HINTS, DEFAULT_PLATFORM_LOGO, type PlatformSettings } from "../../../data/admin-settings";
...
function SettingsBrandingSection({ settings, onChange }: SettingsBrandingSectionProps) {
  ...
  return (
    <SettingsSection id="branding" title="Branding" description="Customize the look and feel of the user dashboard.">
      <div className="space-y-6">
        ...
        <SettingsField label="Favicon" hint={BRANDING_HINTS.favicon}>
          <Button icon={<UploadOutlined />} onClick={() => toast.info("Favicon upload coming soon")} className="ml-2 font-medium!">
            Upload New
          </Button>
        </SettingsField>
      </div>
