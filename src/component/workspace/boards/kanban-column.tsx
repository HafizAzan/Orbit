...
function KanbanColumn({
  ...
  return (
    <section className="flex h-[min(50vh,540px)] w-[min(100%,320px)] shrink-0 snap-start flex-col rounded-2xl bg-muted-surface/80 p-4 sm:w-[300px]">
      ...
      <div className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain pr-1">
        {isEmpty ? (
          <div className="flex h-50 min-h-50 flex-col items-center justify-center rounded-xl border border-dashed border-border/80 bg-background/30 px-4 py-8 text-center">
      ...
      {showAddTask ? (
        ...
        >
          <Button
            ...
            block
            icon={<PlusOutlined />}
            className="h-auto rounded-xl border-dashed py-3 font-medium!"
          >
            Add Task
          </Button>
        </WorkspaceNavLink>
